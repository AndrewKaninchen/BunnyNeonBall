...
namespace PowerSystem.UI
{
	public class EffectParameterSetterPanelManager : ParameterSetterPanelManager, ISubmitHandler
	{
		...
		public override int ParameterValue 
        {
            get { return currentValue; }
            set { currentValue = Mathf.Clamp(value, minValue, maxValue); UpdateText(); UpdateCreatorStat(); }
        }

		public void Initialize (
            MyEventSystem eventSystem, 
            Stat stat, PowerParameterPanelManager powerParameterPanelManager, 
			EffectClassListPanelManager effectClassListPanelManager, 
            PowerListPanelManager powerListPanelManager, 
            GameObject effectParametersListPanel, 
            GameObject parameterPanelPrefab)
		{
